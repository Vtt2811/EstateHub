...
const UpdatePostPage = () => {
  ...
  return (
    <div className="section-container py-10 max-w-6xl">
      <h1 className="font-heading text-display-sm text-navy-900 mb-8">Edit Property Listing</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input id="city" name="city" type="text" defaultValue={postData.city} required className="input-field" />
              </div>
              <div className="md:col-span-2">
                <label htmlFor="address" className="label-text mb-1 block">Street Address</label>
                <input id="address" name="address" type="text" defaultValue={postData.address} required className="input-field" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <input min={1} id="bedroom" name="bedroom" type="number" defaultValue={postData.bedroom} className="input-field" />
              </div>
              <div>
                <label htmlFor="bathroom" className="label-text mb-1 block">Bathrooms</label>
                <input min={1} id="bathroom" name="bathroom" type="number" defaultValue={postData.bathroom} className="input-field" />
              </div>
              <div>
              ...
              <div>
                ...
                <select name="type" defaultValue={postData.type} className="select-field">
              ...
              <div>
                ...
                <select name="property" defaultValue={postData.property} className="select-field">
              ...
              <div>
                ...
                <select name="utilities" defaultValue={postData.postDetail?.utilities} className="select-field">
              ...
              <div>
                ...
                <select name="pet" defaultValue={postData.postDetail?.pet} className="select-field">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <input id="income" name="income" type="text" defaultValue={postData.postDetail?.income} className="input-field" />
              </div>
              <div>
                <label htmlFor="school" className="label-text mb-1 block">School (m)</label>
                <input min={0} id="school" name="school" type="number" defaultValue={postData.postDetail?.school} className="input-field" />
              </div>
              <div>
                <label htmlFor="bus" className="label-text mb-1 block">Bus Stop (m)</label>
                <input min={0} id="bus" name="bus" type="number" defaultValue={postData.postDetail?.bus} className="input-field" />
              </div>
              <div>
                <label htmlFor="restaurant" className="label-text mb-1 block">Restaurant (m)</label>
                <input min={0} id="restaurant" name="restaurant" type="number" defaultValue={postData.postDetail?.restaurant} className="input-field" />
              </div>
            </div>
